      ...
      <div className="w-full max-w-md bg-white rounded-3xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative px-6 py-8 bg-gradient-to-br from-neutral-900 to-neutral-700 text-white">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-white">{record.goalName}</h2>
            </div>
          </div>
        ...
        <div className="px-6 py-8 grid grid-cols-3 gap-4 border-b border-neutral-200">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold text-neutral-900">{record.successRate}%</p>
          </div>
          <div className="text-center">
            <p className="text-neutral-500 text-sm mb-1">총 일수</p>
            <p className="text-3xl font-bold text-neutral-900">{record.totalDays}</p>
          </div>
          <div className="text-center">
            <p className="text-neutral-500 text-sm mb-1">달성일</p>
            <p className="text-3xl font-bold text-neutral-900">{record.completedDays}</p>
          </div>
        </div>
        ...
        <div className="px-6 py-8 border-b border-neutral-200">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-lg font-bold text-neutral-900">주간 진행도</h3>
          </div>
            ...
            {weeklyData.map((week) => {
              ...
              return (
                <div key={week.week} className="flex-1 flex flex-col items-center gap-2">
                  ...
                  <div className="text-center">
                    <p className="text-neutral-900 text-sm font-medium">{week.week}주</p>
        ...
        <div className="px-6 pb-8">
          <button
            onClick={onClose}
            className="w-full py-4 bg-neutral-900 text-white rounded-2xl font-semibold"
          >
            닫기
          </button>
        </div>
