...
export function Camera({ onComplete, onCancel }: Props) {
      ...
      <div className="fixed inset-0 bg-black z-50">
        ...
        <div className="relative w-full h-full flex items-center justify-center bg-neutral-900">
          <div className="text-center">
            ...
            <p className="text-white mb-2">카메라 준비 중...</p>
      ...
      <div className="bg-neutral-900 px-6 pb-8 pt-4">
        <div className="max-w-md mx-auto flex gap-3">
          <button
            ...
            className="flex-1 py-4 bg-neutral-800 text-white rounded-2xl flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="flex-1 py-4 bg-gradient-to-r from-orange-400 to-pink-500 text-white rounded-2xl flex items-center justify-center gap-2"
          >
